...
- Joe Smith\thanks{Somewhereelse University}
...
```{r babyfig, message=FALSE, echo=FALSE, fig.cap='Popularity of James and Elizabeth from 1880 to 2015\\label{fig:babyfig}', fig.height=4, out.extra='', fig.pos='p'}
babynames %>%
