...
using different techniques and co-workers who have different
preferences.
...
It is *very important* to understand that in base R, `df[, 'flour']`
and `df['flour']` are different operations. They appear similar, but
the first extracts and the second subsets:
